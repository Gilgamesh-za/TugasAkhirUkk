      ...
      <div class="container mt-3 h-100">
        ...
        <div class="card" style="overflow:hidden; border-radius: 5px;">
          <div class="card-header text-white" style="background-color: #012970">
            <i class="bi bi-person-workspace"></i> Table Perjalanan
          </div>
          <div class="card-body">
            ...
            <div class="table-responsive" style="text-align:center">
              <table class="table">
                <thead>
                  <a href="/tambah_catatan" class="btn btn-outline-primary" role="button" aria-disabled="true">Tambah Catatan Perjalanan</a>
                ...
                <tbody>
                  ...
                  <?php foreach ($tb_perjalanan as $row) : ?>
                    <tr>
                      ...
                      <td><?= $row['ket'] ?></td>
                      <td>
                        <a href="/edit_catatan/<?= $row['id_perjalanan']; ?>/edit" class="btn btn-outline-success" role="button" aria-disabled="true">Edit</a>
                        <a href="/table_perjalanan/<?= $row['id_perjalanan']; ?>/delete" onclick="returnconfirm('Apakah Yakin?')" class="btn btn-outline-danger" role="button" aria-disabled="true">delete</a>
                      </td>
                    </tr>
                    <?php $i++; ?>
                  <?php endforeach; ?>
